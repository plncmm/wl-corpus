...
parser.add_argument("--corpus", help="Subcorpus name [both|dental]", default="both")
...
p = SamplePicker(args.samples_folder,args.samples_rejected_folder,args.corpus_location,args.corpus)
p.pick(args.n)